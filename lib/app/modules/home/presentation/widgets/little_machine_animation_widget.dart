...
class LittleMachineAnimationWidget extends StatefulWidget {
  const LittleMachineAnimationWidget({Key? key}) : super(key: key);

  @override
  _LittleMachineAnimationWidgetState createState() =>
      _LittleMachineAnimationWidgetState();
}

class _LittleMachineAnimationWidgetState
    extends State<LittleMachineAnimationWidget> {
  ...
  void initState() {
    ...
    rootBundle.load('little_machine.riv').then(
      (data) async {
